...
Component that was made reactive: `,
  ...
  **/
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/jojo/Documents/work-place/madao/shop-chrome-plugins/dev/src/sites/jinritemai.com/components/app.vue"]]);
  ...
  const initApp = async () => {
    ...
    if (HAOHUO_HREF.indexOf("https://fxg.jinritemai.com/ffa/g/create") >= 0) {
      let addSchemeRuleDangerLevel = function({ modifier }) {
        if (app.step !== "ADD_GOODS_DRAFT_INFO") return;
        webHook.addRule({
          urlPattern: "addWithSchema",
          modifier
        });
      }, removeSchemeRuleSafeLevel = function() {
