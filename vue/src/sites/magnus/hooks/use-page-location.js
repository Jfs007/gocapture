import { hashRoutePath } from './use-route-resolver';

export function readCurrentHref(api) {
...
export function pageHostText(href) {
  try {
...
export function pageUrlPath(href) {
  try {
...
export function installLocationWatcher(currentPageHref) {
