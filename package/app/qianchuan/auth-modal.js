...
#__md_qc_auth_modal__ button{cursor:pointer;line-height:32px;min-width:140px;border:1px solid transparent;border-radius:8px;padding:0 12px;color:#fff;background:#3777FF;}
